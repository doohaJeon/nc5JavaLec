...
public class Car {
	...
	public Car(String c) {
		company = c;
		System.out.println("매개변수 하니인 생성자 호출");
	}
	...
	//매개변수명은 어떤 멤버변수를 초기화할지 명확하게 하기위해서 멤버변수명과 일치시킨다.
	public Car(String company, String model, String color) {
		//생성되는 객체 자체를 가르키는 this 키워드 사용해서 멤버변수를 지칭한다.
		this.company = company;
		this.model = model;
		this.color = color;
		System.out.println("매개변수가 세 개인 생성자 호출");
	}
	...
	public Car(String company, String model, String color, int price) {
		...
		this.color = color;
		this.price = price;
		System.out.println("매개변수가 네 개인 생성자 호출");
	}
	
	
	public void carInfo() {
		
		System.out.println(this.company + ", " + this.model + ", " + this.color + ", " + this.price);
	}
