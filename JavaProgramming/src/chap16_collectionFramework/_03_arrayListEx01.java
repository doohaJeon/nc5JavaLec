...
import chap98_homework._3_21_contractWorker;
import chap98_homework._3_21_fullTimeJob;
import chap98_homework._3_21_temporaryJob;
			...
			while(true) {
				...
				switch(input) {
					case 1 : 
						...
						bonus = sc.nextInt();
						new _3_21_fullTimeJob(eno, name, pay, 1, bonus)
						.showEmployeeInfo();
						System.out.println("----------------");
						break;
					case 2 : 
						...
						hireYear = sc.nextInt();
						  new _3_21_temporaryJob(eno, name, pay, 2, hireYear)
						.showEmployeeInfo();
						System.out.println("----------------");
						break;
					case 3 : 
						...
						workDay = sc.nextInt();
						  new _3_21_contractWorker(eno, name, pay, 3, workDay)
						.showEmployeeInfo();
						System.out.println("----------------");
						break;
					case 4 : 
